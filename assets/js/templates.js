    ...
    templates: [
      ...
      },
      {
        ...
        fields: [
          ...
          field("subtitle", "Sous-titre", "Toutes les équipes ES Doubs"),
          field("date", "Dates", "Samedi 5 & dimanche 6 septembre 2026"),
          field(
            "items",
            "Lignes du programme",
      ...
      },
      {
        ...
        description: "Annonce élégante pour un partenariat premium.",
        layout: "sponsor",
        defaultFormat: "instagram-square",
        defaultImage: imagePath + "match-collage.jpg",
        defaultIcon: "megaphone",
        fields: [
          ...
          field("sponsor", "Nom du partenaire", "Carrefour City"),
          field(
            "details",
            "Message",
            "Chaque semaine, l'ES Doubs met à l'honneur un partenaire qui contribue à la vie du club.\n\nCette semaine, merci à Carrefour City pour son engagement concret et durable à nos côtés.",
            "textarea",
          ),
          field("cta", "Appel à l'action", "Ensemble pour l'ES Doubs"),
        ],
      },
      {
        ...
        description: "Annonce de partenariat formel.",
        layout: "sponsor",
        defaultFormat: "facebook",
        defaultImage: imagePath + "captain-handshake.jpg",
        defaultIcon: "megaphone",
        fields: [
          field("title", "Titre", "Nouveau partenaire officiel"),
          field("sponsor", "Nom du partenaire", "Entreprise locale"),
          field(
            "details",
            "Message",
            "L'ES Doubs est fier d'annoncer un nouveau partenariat officiel.\n\nEnsemble, nous construisons un projet ambitieux au service du football local et du développement de nos jeunes.",
            "textarea",
          ),
          field("cta", "Appel à l'action", "Bienvenue dans l'équipe"),
        ],
      },
      {
